...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="d-flex m-0 justify-content-center text-wrap" href="{{ route('home') }}">
      <img height="50" class="logo_conduongbachu" src="{{ asset('assets/images/logo/logo_conduongbachu.webp') }}" alt="logo_conduongbachu">
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ Route::currentRouteNamed('chapters.index') ? 'active' : '' }}" href="{{ route('chapters.index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fa-solid fa-book-open text-dark icon-sidebar"></i>
          </div>
          <span class="nav-link-text ms-1">Danh sách Chương</span>
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link {{ Route::currentRouteNamed('comments.index') ? 'active' : '' }}" href="{{ route('comments.index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fa-solid fa-comment text-dark icon-sidebar"></i>
          </div>
