@extends('layouts.app')
@section('title', 'Trang chủ - Con Đường Bá Chủ')
@section('description',
    'Là thủ khoa với điểm thi đại học cao nhất toàn quốc, lại trở thành một phế vật ở thế giới tu chân tàn khốc, nơi sức
    mạnh chính là luật lệ, cá lớn nuốt cá bé, kẻ yếu chỉ như con kiến không có tiếng nói, bị người người giẫm đạp.
    Hai mắt mù loà, thân phận hèn kém, vạn địch vây quanh...thiếu niên trong tuyệt cảnh thức tỉnh Bá Chủ Hệ Thống, từ đó đặt
    chân vào lằn ranh sinh tử trên con đường tu chân rực rỡ sắc màu.
    Vạn tộc tung hoành, thiên kiêu như nấm, giai nhân làm bạn, khoái ý ân cừu, hành tẩu giang hồ, nhất thống thiên
    địa...viết nên một khúc truyền kỳ bất hủ. Con Đường Bá Chủ là truyện Huyền Huyễn, Tiên Hiệp... ')
@section('keyword',
    'Con Đường Bá Chủ, con duong ba chu,conduongbachu, truyện tranh online, đọc truyện tranh, đọc truyện
    online, CDBC')
